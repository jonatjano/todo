  ...
  findTodoItems() {
    ...
    */
	...
	if(atom.config.get("todo.d_ignoreCommonPaths")) {
		...
		notIgnoredPaths = [...notIgnoredPaths, ...otherNotIgnoredPaths];
	}

    // console.log(notIgnoredPaths);
    // console.log('notIgnoredPaths');
    ...
    // console.log('openedFilesPaths');
    // // notIgnoredPaths = [...notIgnoredPaths, ...openedFilesPaths];
    // console.log(notIgnoredPaths);
    // console.log('notIgnoredPaths');

    // set path to everything if no path is ignored
    function getPaths() {
        if (notIgnoredPaths.length != 0) {
            return notIgnoredPaths;
        }
        return ['*'];
    }
